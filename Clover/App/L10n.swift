...
enum L10n {
    ...
    static let toolbarDisplayModeMenu = String(localized: "toolbar_display_mode_menu", defaultValue: "Toolbar Display")
    static let toolbarDisplayModeIconAndLabel = String(localized: "toolbar_display_mode_icon_and_label", defaultValue: "Icon and Text")
    static let toolbarDisplayModeIconOnly = String(localized: "toolbar_display_mode_icon_only", defaultValue: "Icon Only")
